...
<section class="contact-top position-relative">

	<div class="regular-container contact-btext">

		<div class="w-393">

			<h1 class="event-h1"><?php the_title(); ?></h1>

			<p class="b-info"><?php the_content(); ?></p>
...
<section class="mt-161">

	<div class="regular-container">

		<!-- contact div -->

		<div class="contact-info-w">

			<div class="contact-info-w-1">

				<div class="width-507">

					<h2 class="font-15">Send us a massege</h2>
			...
			<div class="contact-info-w-2">

				<div class="widths-250">

				  <?php if(get_field('contact_information_head','option')){ ?>

					<h2 class="font-15"><?php the_field('contact_information_head','option'); ?></h2>

				  <?php } ?>

					<ul class="listing-contact">

						<?php if(get_field('contact_timing_and_number','option') ): ?>

            			<?php while( the_repeater_field('contact_timing_and_number','option') ): ?>		

						<li class="light-text">

							<p><?php the_sub_field('contact_time_and_num_head','option'); ?></p>

							<p><?php the_sub_field('contact_time_and_num','option'); ?></p>
            			...
            			<?php endif; ?>
						 ...
						 <?php if(get_field('contact_informatie_mail','option') ): ?>

            			  <?php while( the_repeater_field('contact_informatie_mail','option') ): ?>

						<li class="light-text">

							<p><?php the_sub_field('contact_informatie_head','option'); ?></p>

							<p>

							   <?php the_sub_field('contact_sales_mail','option'); ?>

							</p>

							<p>

								<?php the_sub_field('contact_support_mail','option'); ?>
		...
		<div class="space-design">

			<div class="space-design-1 position-relative">

				<svg class="ad-svg" xmlns="http://www.w3.org/2000/svg" width="98.542" height="157.288" viewBox="0 0 56.542 90.288">

					<g id="Group_2059" data-name="Group 2059" transform="translate(-926.568 -2711.808)">

						<path id="Union_254" data-name="Union 254" d="M3.15,43.013A30.287,30.287,0,0,1,.7,35.979a13.34,13.34,0,0,1-.684-4.17l.074-.053Q0,30.591,0,29.4C0,13.163,12.433,0,27.77,0s27.77,13.163,27.77,29.4q0,1.081-.073,2.142a.578.578,0,0,1,.072.268,33.457,33.457,0,0,1-4.062,13.568C42.59,62.33,24.994,88.81,24.994,88.81S9.868,60.1,3.15,43.013Z" transform="translate(927.068 2712.308)" fill="#f39562" stroke="#707070" stroke-width="1"/>

						<g id="Ellipse_518" data-name="Ellipse 518" transform="translate(943.519 2727.494)" fill="#fff" stroke="#707070" stroke-width="1">

							<ellipse cx="11.918" cy="12.929" rx="11.918" ry="12.929" stroke="none"/>

							<ellipse cx="11.918" cy="12.929" rx="11.418" ry="12.429" fill="none"/>
			...
			<div class="space-design-2 position-relative">
				...
				<svg class="eg-mobile" xmlns="http://www.w3.org/2000/svg" width="552" height="453.865" viewBox="0 0 552 453.865">

					<g id="Path_472" data-name="Path 472" fill="#fff">

						<path d="M 551.5 453.3651733398438 L 0.5 453.3651733398438 L 0.5 0.5000152587890625 L 422.892333984375 0.5000152587890625 L 468.1854248046875 48.63880157470703 L 551.5 137.1879730224609 L 551.5 453.3651733398438 Z" stroke="none"/>

						<path d="M 1 1 L 1 452.8651733398438 L 551 452.8651733398438 L 551 137.3861694335938 L 422.67626953125 1 L 1 1 M 0 0 L 423.1084289550781 0 L 552 136.9896545410156 L 552 453.8651733398438 L 0 453.8651733398438 L 0 0 Z" stroke="none" fill="#707070"/>
		...
		<div class="google-Map space-design-Q">

        

		 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2450.289004243729!2d5.0781149152266885!3d52.110870174221574!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c66fa6820911e3%3A0x34cd21d6febd0098!2sVR%20Expert!5e0!3m2!1sen!2sin!4v1643631230967!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
      ...
      <div class="cr-img position-relative">
         ...
         <div class="index-Banner call-us-section">
            ...
            <div class="banner-up">
               ...
               <a class="contact-btn medium-txt" href=""><?php if(get_field('contact_us_cta_text','option')){ ?>
