<?php /* Template Name: Accessoires products*/get_header();?>


<section class="Acc-AllP-list position-relative">
   <div class="regular-container">
        <div class="A-Plist-List">
        <h1 class="h2-heading mb-32">Find accessoires for your headset</h1>
        <div class="FilterFc">
            <ul>
                <li>
                    <a class="header-btn" href="#">All</a> 
                </li>
                <li>
                    <a class="header-btn" href="#">Headset 1</a> 
                </li>
                <li>
                    <a class="header-btn" href="#">Second</a> 
                </li>
                <li>
                    <a class="header-btn" href="#">Fourth</a> 
                </li>
	  ...
	  <div class="Acc-Girds-items">
       ...
       <div class="pagination as-wrap">
	    <ul class="pagination-2 text-right">
            <li class="page-number"><span aria-current="page" class="page-numbers current">1</span></li>
            <li class="page-number"><a class="page-numbers" href="">2</a></li>
            <li class="page-number"><a class="next page-numbers" href="">&gt;</a></li>
        </ul>		
     </div>
