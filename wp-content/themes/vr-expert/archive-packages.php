...
<section class="packages-t position-relative">
	...
	<div class="w-393">
   <?php if(get_field('packages_page_heading','option')){ ?>
         <h1 class="event-h1"> <?php the_field('packages_page_heading','option'); ?></h1>
         <?php } ?>
         <?php if(get_field('packages_page_description','option')){ ?>
         <p class="b-info"><?php the_field('packages_page_description','option'); ?></p>
         <?php } ?>
...
<section class="sec-evnt">
	<div class="regular-container">
		...
		<!-- Grid Layout system 3 pakages start -->
		 <div class="Packages-Div">
				<?php 
						foreach ($query->posts as $value1[0]=>$val){
                           ...
                           $single_packagelink= get_permalink($val->ID);
						?>
			<div class="Packages-item">
				<div class="Packages-item-1">
              <a href="<?php echo $single_packagelink; ?>" class="block">
                  <h2 class="medium-txt mb-0"><?php echo $product_title; ?></h2>
                  <div class="Packages-txts light-txt-g">
                     <p><?php echo $product_content; ?></p>
                  </div>
                  <p class="mid-14">From €<?php if (get_field('package_price', $product_id)){ the_field('package_price', $product_id); } ?>/ Day</p>
               </a>
				</div>
				<div class="Packages-item-2 position-relative">
              <a href="<?php echo $single_packagelink; ?>" class="block">
               <?php if($featuredurl){ ?>
					<img class="img-pkg" src="<?php echo $featuredurl; ?>"  alt="Pico-partner">
               <?php } else { ?>
               <img class="img-pkg" src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png" class="" alt="product-search" >
               <?php } ?>
             </a>
					<div class="triangle-bottomright">
						<a class="x-shop hv-hide" href="">
						 <?php if (get_field('package_popup', $product_id)){ the_field('package_popup', $product_id); } ?>
						</a>
						<div class="x-shop hover-x">
							<a class="a-cart Packageclick" onclick="package_popup('<?php echo get_the_title($product_id); ?>');" href="javascript:void(0)" key="<?php echo $product_id; ?>">
						     	<?php if (get_field('package_popup_hover', $product_id)){ the_field('package_popup_hover', $product_id); } ?>
							</a>
						</div>
					</div>
				</div>
		...
		<!-- Grid Layout system 3 pakages end -->
	</div>
</section>
<!-- start pagination -->
<div class="regular-container">
	<div class="pagination">
	    <?php 
				if (function_exists("vr_pagination")) {
					vr_pagination($query);
				} 
		?>
