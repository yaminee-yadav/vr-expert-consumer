...
<section class="sec-evnt-pagi position-relative">
   <div class="regular-container display-flx">
      <div class="w-393">         
        <?php if(get_field('event_page_heading','option')){ ?>
         <h1 class="event-h1"> <?php the_field('event_page_heading','option'); ?></h1>
         <?php } ?>
         <?php if(get_field('event_page_description','option')){ ?>
         <p class="b-info"><?php the_field('event_page_description','option'); ?></p>
         <?php } ?>
      </div>
   </div>
</section>
   ...
   <div class="regular-container">
      ...
      <div class="event-1">
         <?php 
            ...
            ?>
         <h2 class="event-title-1"><?php echo $term_name; ?></h2>
         <div class="Cover-event open-slider position-relative">
            <div id="f-event1" class="owl-carousel owl-theme">
               <?php $args = array(
                  'post_type' => 'events',
                  'posts_per_page' =>4, 
                  'order' => 'DESC',
                  ...
                  foreach ($query->posts as $value1[0]=>$val){
                      ...
                      $single_eventlink= get_permalink($val->ID);
                  ?>
               <div class="item">
                  <div class="parent-box">
                  <a href="<?php echo $single_eventlink; ?>"> 
                     ...
                     <div class="evnt-data">
                       <a class="hr-color" href="<?php echo $single_eventlink; ?>"> 
                        <div class="cp-event clearfix">
                           <h3 class="event-h3-title medium-txt"><?php 
                            echo mb_strimwidth($product_title, 0, 30, '.....'); ?></h3>
                        </div>
                        ...
                        <div class="txt-ent">
                           ...
                           <?php  
                                            if($product_content){                          
                                                $content = html_cut($product_content, 94); // limit the word count of content
                                                $point  = strlen($product_content) > 94?'...':'';
                                                echo '<p>'.$content. $point.'</p>';  
                                            }                                          
                                            ?>
                              </p>
                        </div>
                        ...
                        <div class="list-Event-Icons">
                           <div class="flx-left">
                              <ul class="list-evnt-img">
                                 <?php
                                    if(get_field('product_assign', $product_id) ){
                                       $assignp_ids = get_field('product_assign', $product_id); 
                                    foreach($assignp_ids as $assignp_id){	
                                       ?>
                                 <li class="position-rt">
                                    <a class="svg-click" href="javascript:void(0)">
                                    <?php $Productimage =get_the_post_thumbnail_url($assignp_id); 
                                          if($Productimage){ ?>
                                       <img src="<?php echo  $Productimage; ?>" class="" alt="slx"> <?Php } else{ ?>   
                                          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png" class="" alt="slx">                  
                                          <?php } ?>
                                    </a>
                                    <div class="hidden-ass">
                                       <a class="a-lnk" href="<?php echo get_the_permalink($assignp_id); ?>">
                                      <?php  if($Productimage){ ?>
                                       <img src="<?php echo  $Productimage; ?>" class="" alt="slx"> <?Php } else{ ?>   
                                          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png" class="" alt="slx">                  
                                          <?php } ?>
                                       
                                       <span class="hover-title"><?php echo get_the_title($assignp_id); ?>></span>
                                       </a>
                                    </div>
                                 </li>
                                 <?php 
                           ...
                           <?php $singleproductlink= get_permalink( $val->ID ); ?>
                           <div class="flx-right">
                              <a class="redmore-al" href="<?php echo $singleproductlink; ?>">Read more> </a>
                           </div>
                        </div>
                     </div>
                  </div>
