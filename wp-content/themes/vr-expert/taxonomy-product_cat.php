...
<section class="packages-t position-relative">
	<div class="regular-container display-flx">
		<div class="w-393">
			<h1 class="event-h1"><?php echo single_term_title();; ?></h1>
			<p class="b-info"><?php echo category_description(); ?></p>
		</div>
	</div>
</section>
<section class="sec-evnt">
	<div class="regular-container">
		...
		<hr class="w-100 mgequal">
		

		<div class="shop-container">
			<div class="shop-child-1">

				<div class="chek-list">
					<h2 class="medium-txt">Type VR bril</h2>
					<div class="users-choose">
					
                    <?php if(have_rows('type_vr_bril_repeater', $term ) ):
                          $i=1; ?>
                     <?php while( have_rows('type_vr_bril_repeater', $term ) ): the_row(); ?>
                     <div class="form-group">
                        
                        <input type="checkbox" class="cus_val" id="DoF_<?php echo $i; ?>" value="<?php the_sub_field('type_vr_bril', $term ); ?>" name="type_brill" onchange="vrill_filter('DoF_<?php echo $i; ?>','<?php echo  $term->term_id;?>');">
                        <label for="DoF_<?php echo $i; $i++; ?>" ><?php the_sub_field('type_vr_bril', $term ); ?></label>
			...
			<div class="shop-child-2" id="filter_data">
            <?php foreach ($loop->posts as $value1[0]=>$val){
                   $product_id = $val->ID; 
                   $product_title = $val->post_title;
                   $product_content= $val->post_content;
                   $singleproductlink= get_permalink($val->ID);
                   $productCat = wc_get_product( $product_id );
                   $product_price= $productCat->get_price();
              ?>
					<div class="p-slide">
               <a class="block" href="<?php echo $singleproductlink; ?>">
						<div class="p-img">
                  <?php $featuredimageurl = get_the_post_thumbnail_url($product_id); ?>
                     <?php if($featuredimageurl){ ?>
							<img src="<?php echo $featuredimageurl; ?>" class="" alt="slx">  
                     <?php } else{ ?><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png" class="" alt="slx">
                        <?php  } ?>
						</div>
                  </a>
						<div class="p-content">
                     ...
                     <?php ?>
								<a href="<?php echo $singleproductlink; ?>"><?php echo mb_strimwidth($product_title, 0, 20, '.....'); ?> </a>
							</h3>
                     <a class="block" href="<?php echo $singleproductlink; ?>">
							<p class="p-description regular-txt"><?php echo mb_strimwidth($product_content, 0, 30, '.....'); ?></p>
							<div class="index-pricing medium-txt">
								<span>
								  From <?php  echo $product_price; ?>/Day
								</span>
							</div>
                     </a>
                 <?php     $booqable_product_ids  = get_post_meta($val->ID,'booqable_product_id',true); 
                                if($booqable_product_ids){ ?>
							<div class="triangle-bottomright">
								<a class="x-shop hv-hide" href="javascript:void(0);" onclick="open_popup(<?php echo $val->ID; ?>);">
								...
								<div class="x-shop hover-x">
									<a class="a-cart" href="javascript:void(0);" onclick="open_popup(<?php echo $val->ID; ?>);">
                     ...
                     <?php }else{ ?>
                        ...
                        <div class="triangle-bottomright">
								<a class="x-shop hv-hide" href="javascript:void(0);" onclick="add_to_cart(<?php echo $val->ID; ?>);">
									<svg id="Group_1498" data-name="Group 1498" xmlns="http://www.w3.org/2000/svg" width="18.467" height="14.729" viewBox="0 0 18.467 14.729">
										<rect id="Rectangle_273" data-name="Rectangle 273" width="12.082" height="1.59" rx="0.795" transform="translate(5.432 10.597)" fill="#fff"></rect>
										<circle id="Ellipse_64" data-name="Ellipse 64" cx="1.59" cy="1.59" r="1.59" transform="translate(4.478 11.55)" fill="#fff"></circle>
										<circle id="Ellipse_65" data-name="Ellipse 65" cx="1.59" cy="1.59" r="1.59" transform="translate(14.971 11.55)" fill="#fff"></circle>
								...
								<div class="x-shop hover-x">
									<a class="a-cart" href="javascript:void(0);" onclick="add_to_cart(<?php echo $val->ID; ?>);">
										<svg xmlns="http://www.w3.org/2000/svg" width="28" height="55" viewBox="0 0 28 55">
											<text id="_" data-name="+" transform="translate(0 41)" fill="#fff" font-size="39" font-family="Poppins-Medium, Poppins" font-weight="500">
												<tspan x="0" y="0">+</tspan>
											</text>
...
<?php if ( function_exists('faqs') ) { ?>
   <?php if(get_field('faqs_left_repeater1','product_cat_'.$term->term_id) ){ ?>
