<?php get_header(); ?>
<section class="top-section-slider">
  <div class="regular-container">
    <div class="full-bc">
      <div id="main-carousel" class="owl-carousel">
        <?php if(get_field( "hero_section_repeater" )): ?>
        <?php while(the_repeater_field('hero_section_repeater') ): ?>
        <div class="item">
          <div class="fl-x-lap">
            <div class="fl-text">
              <h2 class="slider-heading"><?php the_sub_field('heading'); ?></h2>
              <p class="slider-sub-heading"><?php the_sub_field('subheading'); ?></p>
              <p class="mb-0"><a class="header-btn" href="<?php the_sub_field('cta_link'); ?>"><?php the_sub_field('cta_text'); ?></a></p>
            </div>
            <div class="fl-sl position-relative">
              <?php if(get_sub_field('image')){ ?>
              <img   class="img-375" src="<?php the_sub_field('image'); ?>" alt="product-search">
              <?php }else{ ?>
              <img   class="img-375" src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png" alt="product-search">
              <?php } ?>
            </div>
          </div>
        </div>
  ...
  <div class="regular-container position-relative">
    <div class="index-product slider">
      <div class="owl-slider">
        <div id="carousel-products" class="owl-carousel">
          <?php
            if( get_field('assign_products') ){
             $product_id = get_field('assign_products');
            foreach($product_id as $p_id ){
            $product_cart_id = WC()->cart->generate_cart_id($p_id);
            
            $in_cart = WC()->cart->find_product_in_cart( $product_cart_id);
            
            ?>
          <div class="item">
            <div class="p-slide <?php if($in_cart){ echo"product_selected";}?>">
              <a class="alink-c" href="<?php echo get_permalink($p_id); ?>">
                <?php $Singleproduct = get_the_post_thumbnail($p_id);
                  if($Singleproduct){ ?>
                <div class="p-img">
                  <?php echo $Singleproduct; ?>
                </div>
                <?php }else{ ?>
                <div class="p-img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png"  alt="slx"></div>
                <?php } ?>
                <div class="p-content">
                  <h3 class="p-title medium-txt">
                    <?php echo mb_strimwidth(get_the_title($p_id), 0, 30, '.....'); ?>
                  </h3>
                  <p class="p-description regular-txt"><?php echo mb_strimwidth(get_the_excerpt($p_id), 0, 49, '.....'); ?></p>
                  <div class="index-pricing medium-txt">
                    <span>
                    <?php   $product = wc_get_product( $p_id );
                      $neprice = $product->get_price();
                      
                      ?>
                    From €<?php echo $neprice; ?>/Day
                    </span>
                  </div>
              </a>
              ...
              <?php $booqable_product_ids  = get_post_meta($product->get_id(),'booqable_product_id',true); 
                if($booqable_product_ids){  
                foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                }
                ?>
              <a class="x-shop hv-hide front-popupcall" href="javascript:void(0)" data-prod="<?php echo $p_id; ?>" data-key="<?php echo $cart_item_key; ?>" >
              ...
              <a class="a-cart front-popupcall" href="javascript:void(0)" data-prod="<?php echo $p_id; ?>" data-key="<?php echo $cart_item_key; ?>">
              ...
              <?php   } else{ ?>
              <a class="x-shop hv-hide" href="javascript:void(0);" onclick="add_to_cart(<?php echo $p_id; ?>);">
              <svg id="Group_1498" data-name="Group 1498" xmlns="http://www.w3.org/2000/svg" width="18.467" height="14.729" viewBox="0 0 18.467 14.729">
              <rect id="Rectangle_273" data-name="Rectangle 273" width="12.082" height="1.59" rx="0.795" transform="translate(5.432 10.597)" fill="#fff"/>
              <circle id="Ellipse_64" data-name="Ellipse 64" cx="1.59" cy="1.59" r="1.59" transform="translate(4.478 11.55)" fill="#fff"/>
              <circle id="Ellipse_65" data-name="Ellipse 65" cx="1.59" cy="1.59" r="1.59" transform="translate(14.971 11.55)" fill="#fff"/>
              ...
              <div class="x-shop hover-x">
              <input type="hidden" id="product_id_simple" name="product_id_simple" value="<?php echo $p_id; ?>">
              <a class="a-cart" href="javascript:void(0);" onclick="add_to_cart(<?php echo $p_id; ?>);">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="55" viewBox="0 0 28 55">
              <text id="_" data-name="+" transform="translate(0 41)" fill="#fff" font-size="39" font-family="Poppins-Medium, Poppins" font-weight="500">
              <tspan x="0" y="0">+</tspan>
              </text>
...
<section class="Accesoires-Home" >
  <div class="regular-container position-relative">
	  <h2 class="Maineach-head">Headsets </h2>
          <div class="Acc-Girds-5">
		  ...
		  <div class="Cart-Vatul">

<div class="Cart-Vatul-1">
<a class="header-btn" href="#">
	Read More
</a>	
</div>
<div class="Cart-Vatul-2">
<div class="CV-price">€ 15,-</div>
<a class="header-btn" href="#">
	<span class="svgcart"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M96 0C107.5 0 117.4 8.19 119.6 19.51L121.1 32H541.8C562.1 32 578.3 52.25 572.6 72.66L518.6 264.7C514.7 278.5 502.1 288 487.8 288H170.7L179.9 336H488C501.3 336 512 346.7 512 360C512 373.3 501.3 384 488 384H159.1C148.5 384 138.6 375.8 136.4 364.5L76.14 48H24C10.75 48 0 37.25 0 24C0 10.75 10.75 0 24 0H96zM128 464C128 437.5 149.5 416 176 416C202.5 416 224 437.5 224 464C224 490.5 202.5 512 176 512C149.5 512 128 490.5 128 464zM512 464C512 490.5 490.5 512 464 512C437.5 512 416 490.5 416 464C416 437.5 437.5 416 464 416C490.5 416 512 437.5 512 464z"/></svg>
   </span> +
</a>
</div>
  ...
  <div class="regular-container position-relative">
    ...
    <div class="appUl appUlStore">
      <div class="Appli-img-txt">
        ...
        <a class="header-btn" href="#">About us ></a>
      </div>
      <div class="Appli-img">
