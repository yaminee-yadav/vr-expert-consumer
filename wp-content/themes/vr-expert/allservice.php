<?php get_header();
	 ...
	 * Template Name: allservicespage

	 */

	?>

<section class="services-top position-relative">

	<div class="regular-container display-flx">

		<div class="w-393">

			<h1 class="event-h1"><?php echo the_title(); ?></h1>

			<p class="b-info"><?php echo the_content();?></p>
...
<section class="four-items">

	<div class="regular-container">

		<div class="f-items">

		  <?php if( have_rows('service_page_options') ){ ?>

			<?php while( have_rows('service_page_options') ){ the_row();?>

			<div class="fchild-1 position-relative">
				
            <div class="sq-53">

             <?php if(get_sub_field('service_options_img1')){ 
					
                the_sub_field('service_options_img1'); 
              ...
              <?php if(get_sub_field('service_options_img2')){ 
					
               the_sub_field('service_options_img2'); 
             ...
             <?php } ?>
				...
				<div class="max-114 medium-txt">

				<?php the_sub_field('service_options_text'); ?>
...
<section class="service-1">
	...
	<div class="regular-container">
		...
		<div class="sr-parents-1">

			<div class="parents-1-child">

				<?php if(get_field('installation_service_image')){?>

				<img src="<?php the_field('installation_service_image'); ?>"  alt="slx"> 
			...
			<div class="parents-2-child">

				<div class="services-wraper">

				   <?php if(get_field('installation_service_head')){?>

					<h2 class="h2-heading"><?php the_field('installation_service_head'); ?></h2>

					<?php }?>

					<div class="wd-368 regular-txt">

					<?php if(get_field('installation_service_paragraph')){?>

						<p class="sv-txt"><?php the_field('installation_service_paragraph'); ?></p>

						<?php }?>

						<ul class="sv-imp-list">

						<?php if(get_field('installation_service_points')){

							    the_field('installation_service_points');
					...
					<div class="dsk-ddddd">
						...
						<?php if(get_field('user_experience_head')){?>

							<h3 class="h2-heading"><?php the_field('user_experience_head'); ?></h3>
                        ...
                        <div id="svc-event-services" class="aws-hidden owl-carousel owl-theme"> 

                                 <?php

                                       if(get_field('assign_events') ){

                                          $assignp_ids = get_field('assign_events',$val->ID); 
                                    ...
                                    <div class="item">
                                       ...
                                       <div class="srv1-evnt">
                                          ...
                                          <div class="sq-54">
                                             <?php $Original_image_url = get_the_post_thumbnail_url($assignp_id);
                                          ...
                                          <h2 class="medium-txt"><?php echo mb_strimwidth(get_the_title($assignp_id), 0, 20, '.....'); ?></h2>

                                          <div class="srv1-txt light-text">

                                             <?php

                                             echo mb_strimwidth(get_the_content($assignp_id), 0, 160, '.....'); ?>

                                          </div>

                                          <div class="text-right">

                                          <?php $singleeventlink= get_permalink( $assignp_id ); ?>

                                             <a class="redmore-al" href="<?php echo $singleeventlink; ?>">Read more &gt;</a>
	...
	<div class="Ev-show">
		...
		<div class="regular-container">
			...
			<div class="dsk-tab-ddddd">

           <?php   if(get_field('assign_events') ){

                   $assignp_ids = get_field('assign_events',$val->ID); ?>

				<h3 class="h2-heading">Usersss Experience</h3>
				...
				<div class="ol-same">
                    ...
                    <?php
                     ...
                     ?>
                           ...
                           <?php $singlelink= get_permalink( $val->ID ); ?>

										<a class="redmore-al" href="<?php echo $singlelink; ?>">Read more &gt;</a>
		...
		<div class="sr-parents-1">
			...
			<div class="parents-2-child">
				...
				<div class="services-wraper">
				 ...
				 <?php if(get_field('event_service_heading')){?>

					<h2 class="h2-heading"><?php the_field('event_service_heading'); ?></h2>

				 <?php }?>

					<div class="wd-368 regular-txt">

					   <?php if(get_field('event_service_paragraph')){?>

						<p class="sv-txt"><?php the_field('event_service_paragraph'); ?></p>

						<?php }?>

						<ul class="sv-imp-list">

						 <?php if(get_field('event_service_points')){

							    the_field('event_service_points');
					...
					<div class="dsk-ddddd">
					  ...
					  <?php if(get_field('event_user_experience_head')){?>

							<h3 class="h2-heading"><?php the_field('event_user_experience_head'); ?></h3>
			...
			<div class="parents-1-child">
				...
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/image-sr-1.png"  alt="slx"> 
