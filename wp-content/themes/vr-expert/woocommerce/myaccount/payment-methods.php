...
<?php if ( $has_methods ) : ?>
	...
	<table class="woocommerce-MyAccount-paymentMethods shop_table shop_table_responsive account-payment-methods-table  woocommerce-MyAccount-orders account-orders-table">
		<thead>
			<tr>
