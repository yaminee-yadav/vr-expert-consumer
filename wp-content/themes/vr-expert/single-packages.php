...
<section class="p-single">
		 <?php $thumbnailimage= get_the_post_thumbnail_url(); if( $thumbnailimage){ ?>
	<div class="p-all">
		<img src="<?php echo $thumbnailimage; ?>" class="" alt="slx"> 
	</div>
	<?php }else { ?>
		<div class="p-all">
...
<!-- section -two one -->
<section class="Icaros-section">
	<div class="regular-container position-relative">
		<div class="flex-row-w">
			<div class="flex-w294">
				<p class="pk_title"><?php the_title(); ?></p>
				<?php $package_id = get_the_id(); ?>
			</div>
			<div class="flex-w335">
				<p class="regular-txt">Rent date<span>*</span></p>
				<div class="width-255">
					<div class="D-Date">
						<div class="Daticons">
							<svg id="Group_1281" data-name="Group 1281" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
								<path id="Path_2499" data-name="Path 2499" d="M0,0H24V24H0Z" fill="none"/>
								<path id="Path_2500" data-name="Path 2500" d="M2,11H22v9a1,1,0,0,1-1,1H3a1,1,0,0,1-1-1ZM17,3h4a1,1,0,0,1,1,1V9H2V4A1,1,0,0,1,3,3H7V1H9V3h6V1h2Z" fill="#f59663"/>
							</svg>
						</div>
						<div class="Date-1 regular-txt position-relative">
							<input id="date_to_start" type="input" class="date_to_start" placeholder="Start Date" name="date_to_start" value="" required>
						</div>
						<div class="ddline position-relative">
							-
						</div>
						<div class="Date-2 regular-txt position-relative">
							<input id="date_to_end" type="input" class="date_to_end" placeholder="End Date" name="date_to_end"  value="" required>
						</div>
					</div>
					<!-- d ate end -->
				</div>
			...
			<div class="flex-w185">
				...
				<p class="pk_price">€ <?php  the_field('package_price'); ?>,-</p>
				<p class="regular-txt">Price per 1 day</p>
				<?php } ?>
			</div>
			<div class="flex-w274">
				<div class="div-rtb pk-request">
					<div class="btn-popup-css">
						<button class="a-cart thnks-p" onclick="single_package('<?php echo get_the_title($package_id); ?>')" href=""><span class="s1">Request</span><span class="s2">Request</span>
					    </button>
					</div>
					<span class="txt202">Only bookable on request</span>
				</div>
			</div>
		</div>
	</div>
...
<!-- end ist section -->
<section class="section-step pk-single">
	<div class="regular-container position-relative">
		<div class="stepwise">
			<div class="w-1008">
					<ol class="steps">
...
<?php 
			$packagePara = get_field('packages_content1_paragraph');
			$imgs = get_field('packages_content1_images');
			if(($packagePara)||($imgs)){ ?>
<section class="p-stap1">
	<div class="w-1194">
		<div class="im1-f1">
			<div class="w-1073">
				<div class="w-10731">
					<div class="w-406 light-txt position-relative">
						<?php if(get_field('packages_content1_head')){ ?>
							<h2><?php the_field('packages_content1_head'); ?></h2>
						<?php  } ?>
						<?php 
						  if($packagePara){ ?>
							<p> <?php the_field('packages_content1_paragraph'); ?></p>
						<?php  } ?>
					</div>
					<div class="w-565">
					<?php	
					 ...
					 <?php if($imgs){ ?>
						...
						<img src="<?php echo wp_get_attachment_image_url($imgs, $size); ?>" class="" alt="slx">
					 <?php  } else{ ?>
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png" class="" alt="product-search" >
					<?php } ?>
					</div>
...
<?php if(get_field('packages_mode') ): ?>
<section class="msection-2">
	<div class="regular-container position-relative">
		<div class="ex-grids">
		   
              <?php while( the_repeater_field('packages_mode') ): ?>
			<div class="ex-grids-child">
				<h2 class="line-18-m"><?php the_sub_field('package_mode_heading'); ?></h2>
				<div class="ex-grids-inner">
					<div class="w-198">
					<?php if(get_field('packages_content2_images')){ ?>
						<img src="<?php the_field('packages_content2_images'); ?>" class="" alt="slx">
					 <?php  } ?>
					</div>
					<div class="w-326 regular-txt">
						<?php the_sub_field('packages_mode_paragraph'); ?>
					</div>
				</div>
			</div>
			  <?php endwhile; ?>
...
<?php       
            $packagePara2 = get_field('packages_content2_paragraph');
			$imgs2 = get_field('packages_content2_images');
			if(($packagePara)||($imgs)){ ?>
<section class="p-stap3">
	<div class="w-1194">
		<div class="im1-f1">
			<div class="w-1073">
				...
				<div class="w-10731">
					...
					<div class="w-406 position-relative light-txt">
					    <?php if(get_field('packages_content2_head')){ ?>
							<h2><?php the_field('packages_content2_head'); ?></h2>
						<?php  } ?>
						<?php if($packagePara2){ ?>
							<p> <?php the_field('packages_content2_paragraph'); ?></p>
						<?php  } ?> 
				</div>
			</div>
		</div>
...
<?php $SevaShare = get_field('seva_and_share_repeater');
if($SevaShare){ ?>
<section class="Hover-Tab">
	<div class="regular-container position-relative">
		<h3 class="medium-txt">Seva and share</h3>
		<div class="H-elment">
			<div class="H-child-1">
			 <?php if($SevaShare): ?>
			  <?php $i=1; ?>
             <?php while( the_repeater_field('seva_and_share_repeater') ): ?>
				<div class="target-tabsP" id="tabimg<?php echo $i; $i++; ?>" >
				  <?php if(get_sub_field('share_image')){ ?>
					<img src="<?php the_sub_field('share_image'); ?>" class="" alt="slx">
                    <?php }else{ ?>
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png" class="" alt="slx">
					<?php } ?>
				</div>
				<?php endwhile; ?>
       			 <?php endif; ?>
			...
			<div class="H-child-2">
				<ul class="ul-1">
					...
					<li class="tl-li">
						<div class="al-w">
							<a class="li-li" href="#tabimg<?php echo $i; $i++; ?>"><?php  echo $j; $j++; ?></a>
						</div>
						<div class="tx-dsc">
							<h2 class="medium-txt"><?php the_sub_field('share_heading'); ?></h2>
							<p class="light-txt">
							<?php the_sub_field('share_paragraphs'); ?>
							</p>
						</div>
					</li>
					<?php endwhile; ?>
...
<?php $package_qualities = get_field('package_qualities_repeater'); 
if($package_qualities){ ?>
<section class="vr-sec p-tab-section pkg-tabs">
	<div class="w-1194">
		<div class="related-Tabs">
			<div class="w-1073">
				<div class="tabs mb-hide">
					<ul id="tabs-nav-c" class="t-tabs">
						<?php if(get_field('packages_description_heading') ): ?>
						<?php $i=1;?>
						<?php while( the_repeater_field('packages_description_heading') ): ?>
						 <li><a class="medium-txt" href="#tab<?php echo $i; $i++; ?>"><?php the_sub_field('package_description_head'); ?></a></li>
						<?php endwhile; ?>
       			  		<?php endif; ?>
					</ul>
					...
					<div id="tabs-content">
						...
						<div id="tab<?php echo $i; $i++; ?>" class="tab-content">
							<div class="grid-33">
								<div class="items-33">
									<ul class="spec-K">
									  <?php if(get_field('package_qualities_repeater') ): ?>
										<?php while( the_repeater_field('package_qualities_repeater') ): ?>
										<li class="regular-txt">
											<div class="ic-check ">
												<span class="box-22">
													<svg xmlns="http://www.w3.org/2000/svg" width="17.457" height="14.627" viewBox="0 0 17.457 14.627">
														<g id="Group_2056" data-name="Group 2056" transform="translate(-2.46 -5.419)">
															<path id="Path_646" data-name="Path 646" d="M5627.248,1578.36l6.524,7.51,9.379-12.437" transform="translate(-5624.033 -1567.412)" fill="none" stroke="#fff" stroke-width="2"/>
														</g>
													</svg>
												</span>
											</div>
											<div class="ic-text"><?php the_sub_field('package_quality_points'); ?></div>
										</li>
										<?php endwhile; ?>
       			  						<?php endif; ?>
									</ul>
							    	...
							    	<?php if(get_field('package_quality_box_repeater') ): ?>
									<?php while( the_repeater_field('package_quality_box_repeater') ): ?>
									<div class="items-33">
										<ul class="tech-info">
										  <?php 
										  if( have_rows('package_quality_second_repeater') ):
											while( have_rows('package_quality_second_repeater') ) : the_row();
								          ?>
											<li class="tech-li">
												<div class="text-li-1 mid-14">
												 <?php the_sub_field('package_quality_head'); ?>         
												</div>
												<div class="text-li-2 light-txt">
												 <?php the_sub_field('package_qualities'); ?>
												</div>
											</li>
											<?php endwhile; ?>
       			  							<?php endif; ?>
						...
						<div id="tab<?php echo $i; $i++; ?>" class="tab-content">
							<div class="grid-6">
							  <?php if(get_field('package_product_specialities') ): ?>
								<?php while( the_repeater_field('package_product_specialities') ): ?>
								<div class="items-6">
									<div class="img-I">
										<img  src=" <?php the_sub_field('package_product_specialities_image'); ?>"  alt="Pico-partner">
									</div>
									<div class="Img-Ip">
										<p class="mid-14"><?php the_sub_field('package_product_specialities_head'); ?></p>
									</div>
								</div>
								<?php endwhile; ?>
       			  				<?php endif; ?>
				...
				<div class="mbb-mobile position-relative">
					<div class="mb-n-tab">
                        ...
                        <?php $k=1; ?>
                        <?php while( the_repeater_field('packages_description_heading') ): ?> 
							<option  class="medium-txt" value="pro_info<?php echo $k; $k++;?>"><?php the_sub_field('package_description_head'); ?></option>
						<?php endwhile; ?>
       			  		<?php endif; ?>
					...
					<div id="display-1" class="asc-x">
						<?php $k=1; ?>
						<div class="sl-v colors" id="pro_info<?php echo $k; $k++;?>">
						<div class="grid-33">
								<div class="items-33">
									<ul class="spec-K">
									  <?php if(get_field('package_qualities_repeater') ): ?>
...
<?php 
		    $postid = get_the_ID();
		   if( get_field('other_related_packages', $postid) ){ ?>
<section class="pk-sliders">
	<div class="regular-container position-relative">
		<div class="index-product slider">
			...
			<div class="owl-slider position-relative">
				<div id="" class="dmw-packages owl-carousel">                
					<?php $pkg_id = get_field('other_related_packages',$postid ); 
						 foreach($pkg_id as $pkg_ids){ 
							$post_title=get_the_title($pkg_ids);
							$post_content=get_the_content($pkg_ids); 
							$post_thumbnail=get_the_post_thumbnail_url($pkg_ids);
							$posts = get_post($pkg_ids);
							 ?>
							<div class="item">
								<div class="Packages-item">
									<div class="Packages-item-1">
										<a href="<?php echo get_site_url().'/packages/'.$posts->post_name ?>">
										<h2 class="medium-txt mb-0"><?php echo mb_strimwidth($post_title, 0, 15, '.....'); ?></h2>
										<div class="Packages-txts light-txt-g">
											<p><?php echo mb_strimwidth($post_content, 0, 100, '.....'); ?></p>
										</div>
										<p class="mid-14">From €<?php if (get_field('package_price', $pkg_ids)){ the_field('package_price', $pkg_ids); } ?>/ Day</p>
						 				</a>
									</div>
									<div class="Packages-item-2 position-relative">
										<?php if($post_thumbnail){ ?>
										<img class="img-pkg" src="<?php echo $post_thumbnail; ?>"  alt="Pico-partner">
										<?php }else { ?>
											<img class="img-pkg" src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png"  alt="Pico-partner">
										<?php } ?>
										<div class="triangle-bottomright">
											<a class="x-shop hv-hide" href="">
												<svg xmlns="http://www.w3.org/2000/svg" width="15.978" height="17.753" viewBox="0 0 15.978 17.753">
													<path id="Path_4974" data-name="Path 4974" d="M18.978,8.214V18.859a.888.888,0,0,1-.881.894H3.881A.881.881,0,0,1,3,18.873V2.881A.89.89,0,0,1,3.886,2h8.878V7.326a.888.888,0,0,0,.888.888Zm0-1.775H14.54V2Zm-11.54,0V8.214H10.1V6.438Zm0,3.551v1.775h7.1V9.989Zm0,3.551v1.775h7.1V13.54Z" transform="translate(-3 -2)" fill="#fff"/>
												</svg>
											</a>
											<div class="x-shop hover-x">
												<a class="a-cart thnks-p" onclick="single_package('<?php  echo get_the_title($pkg_ids);?>');" href="javascript:void(0)">
...
<?php if( get_field('event_assign') ){ ?>
<div class="vr-sec">
	<div class="w-1194">
		<div class="vr-ex-evnt">
			<div class="w-1073">
			<?php 
					$assignevntid = get_field('event_assign', get_the_id()); 
			?>
				<h2 class="serve-heading ev-title">Example events</h2>
				<div class="owl-slider position-relative">
					<div id="evnt-rel-products" class="owl-carousel">
					 <?php foreach($assignevntid as $evntid){ 
						 $evnt_title= get_the_title($evntid); 
						 $evnt_content = get_the_content($evntid);
						 $evnt_thumbnail= get_the_post_thumbnail_url($evntid);
						 $single_evntlink = get_permalink($evntid);
						 ?>
						<div class="item">
							<div class="eev-vr">
								<a href="<?php echo $single_evntlink; ?>">
								<div class="h-189">
									<?php if($evnt_thumbnail){ ?>
								  <img class="img-pkg" src="<?php echo $evnt_thumbnail; ?>"  alt="Pico-partner">
								  <?php }else { ?>
									<img class="img-pkg" src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png"  alt="Pico-partner">
								  <?php } ?>
								</div>
								<div class="eevnt-p">
									<h2 class="medium-txt"><?php echo  mb_strimwidth($evnt_title, 0, 30, '.....'); ?> </h2>
									<div class="text-limit light-text">
										<p><?php echo mb_strimwidth($evnt_content, 0, 100, '.....'); ?></p>
									</div>
									<div class="text-right">
										<a class="regular-txt readmore" href="<?php echo $single_evntlink; ?>">Read more&gt;</a>
									</div>
								</div>
								 </a>
							</div>
