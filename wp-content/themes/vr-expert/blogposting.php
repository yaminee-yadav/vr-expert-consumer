<?php /* Template Name: blog listing Posting*/get_header();?>

<section class="blog-cover">
  <div class="backgroundImg"  style="background: url(https://brandactivation.com/wp-content/uploads/2017/02/Audi_Airbnb_Desolation_campaign-1600x1068-1600x1068.jpg) center center no-repeat;"></div>
  <div class="gradient-bottom"></div>
  <div class="overlaytxt">
    <h1>Game title</h1>
  </div>
</section>
<section class="B-Bog-List Blog-posting">
...
<!-- section Supported headset -->
<section class="Accesoires-Home supported-headset">
  <div class="regular-container position-relative">
  <h2 class="Maineach-head">Supported headset </h2>
...
<!-- Supported headset end -->
<!-- section Related software  -->
<section class="Hot5-section Uses-levelR">
<div class="regular-container position-relative">
<div class="Hot-5">
<h2 class="Maineach-head">Related software</h2>
