...
<section class="ab-about">
    ...
    if ( has_post_thumbnail() ) {
      ...
      echo wp_get_attachment_url(29560); 
    }
...
<section class="ab-about-text querty">
  ...
  <div class="regular-container">
    ...
    <div class="move-about">

      <div class="w-568">

        <h2 class="slider-heading"><?php echo the_title(); ?></h2>

        <div class="about-ab regular-16">
...
<section class="about-help">
  ...
  <div class="width-12066">

    <div class="helping-div-ii">

      <div class="helping-div">

        <h2 class="h2-heading"><?php if(get_field('helping_option_heading')){ the_field('helping_option_heading'); } ?></h2>

        <div class="g-help">

          <?php if( have_rows('helping_options') ){ ?>

          <?php while( have_rows('helping_options') ){ the_row();?>

          <div class="g-help-child position-relative">

            <div class="sq-53">

              <?php the_sub_field('helping_option_svg1'); ?>

            </div>

              <?php the_sub_field('helping_option_svg2'); ?>

            <div class="wd-159 medium-txt">

              <?php the_sub_field('helping_option_text'); ?>
...
<section class="about-box-txt">

  <div class="fl-width-100">

    <div class="width-hf-50 colrs-back">

      <div class="flex-t-div">

        <h2 class="h2-heading"><?php the_field('productinformatie_heading'); ?></h2>

        <div class="about-p-content regular-txt">

          <div class="flex-t-child">

            <?php the_field('productinformatie_data'); ?>
    ...
    <div class="width-hf-50 image-back">
      <?php if(get_field('productinformatie_image')){ ?>
      <img src="<?php the_field('productinformatie_image'); ?>" class="" alt="slx">
      <?php } else { ?>
        <img src="<?php echo wp_get_attachment_url(29560); ?>" class="" alt="slx">
        <?php } ?>
    </div>

  </div>

  <div class="fl-width-100 second-txt">

    <div class="width-hf-50 image-back">
    <?php if(get_field('productinformatie_image1')){ ?>
      <img src="<?php the_field('productinformatie_image1'); ?>" class="" alt="slx">
      <?php } else { ?>
        <img src="<?php echo wp_get_attachment_url(29560); ?>" class="" alt="slx">
        <?php } ?>
    </div>
    ...
    <div class="width-hf-50 colrs-back">
      ...
      <div class="flex-t-div">
        ...
        <h2 class="h2-heading"><?php the_field('productinformatie_heading1'); ?></h2>

        <div class="about-p-content regular-txt">

          <div class="flex-t-child">

          <?php the_field('productinformatie_data1'); ?>
...
<section class="ab-contact">
  ...
  <div class="regular-container">
    ...
    <div class="tw-flex">
      ...
      <div class="tw-flex-ch1">

        <h2 class="medium-txt">Send us a massege</h2>

        <div class="about-zero-content position-relative">
