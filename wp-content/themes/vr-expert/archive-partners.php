...
<section class="sec-evnt-pagi partners-t position-relative">

  <div class="regular-container display-flx">

    <div class="w-393">

    <?php if(get_field('partner_page_heading','option')){ ?>
         <h1 class="event-h1"> <?php the_field('partner_page_heading','option'); ?></h1>
         <?php } ?>
         <?php if(get_field('partners_page_description','option')){ ?>
         <p class="b-info"><?php the_field('partners_page_description','option'); ?></p>
         <?php } ?>
         ...
         <?php $args = array(
                ...
                <div class="partners-item">
                    ...
                    <a class="block" href="">
                       ...
                       <h3 class="h3-title medium-txt"><?php echo mb_strimwidth($product_title, 0, 20, '.....'); ?></h3>

                        <div class="partner-Banner">
                           <?php if($featuredurl){ ?>
                            <img src="<?php echo $featuredurl; ?>"  alt="Pico-partner">
                            <?php }else{ ?><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/woocommerce-placeholder.png"> <?php } ?>
                       ...
                       <a class="block" href="">
                            ...
                            <div class="text-min light-text">

                             <?php echo mb_strimwidth($product_content, 0, 230, '.....'); ?>
                            ...
                            <div class="listing position-relative">
                                ...
                                <?php
                                    ...
                                    if(get_field('product_assign') ){

                                       $assignp_ids = get_field('product_assign',$val->ID); 

                                    foreach($assignp_ids as $assignp_id){	
                                          $product_thumbnailurl= get_the_post_thumbnail_url($assignp_id);
                                       ?>

                                    <li> 

                                    <a class="svg-click" href="">

                                   <?php if($product_thumbnailurl){
                                          ?>
                                       <img src="<?php echo $product_thumbnailurl; ?>" class="" alt="slx">                                           
                                          <?php }else {?>
                                    ...
                                    <div class="hidden-ass">
                                                ...
                                                <a class="a-lnk" href="<?php echo get_permalink($assignp_id); ?>">
                            ...
                            <div class="text-right">
                             ...
                             <a class="redmore-al" href="<?php echo get_site_url().'/events/' ?>the-blue-curacao-experience"> Read more&gt; </a>
