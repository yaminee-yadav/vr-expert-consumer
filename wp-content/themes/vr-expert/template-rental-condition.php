<?php get_header();
	 ...
	 * Template Name: retal-condition-page
...
<section class="rantal-con-txt">

	<div class="regular-container">

		<div class="cond-vr-wrap">

			<h1 class="txt-h1-heading"><?php the_title(); ?></h1>

			<div class="grid-3">

			 <?php if( have_rows('rental_data') ){ ?>

               <?php while( have_rows('rental_data') ){ the_row();?>

				<div class="grid-3-child">

					<h2 class="header_title"><?php the_sub_field('rental_head'); ?></h2>

					<div class="rantal-mtxt light-text">

						<p><?php the_sub_field('rental_paragraph'); ?></p>

					</div>

					<div class="ul-rantal-div">

						<ul class="sv-imp-list light-text">

						    <?php the_sub_field('rental_points'); ?>
...
<section class="Aks">
	...
	<div class="regular-container products-mg-txt">

		<div class="row-gs">

			<div class="row-gs-1 Img-sample text-center">

				<img src="<?php if(get_field('rental_vr_images')){ the_field('rental_vr_images'); }?>"  alt="slx"> 

			</div>

			<div class="row-gs-1">

				<h2 class="header_title"><?php if(get_field('rental_vr_head')){the_field('rental_vr_head'); }?></h2>

				<div class="text-updation light-text">

					<p><?php if(get_field('rental_vr_paragraph')){ the_field('rental_vr_paragraph'); }?></p>
		...
		<div class="row-gs">
			...
			<div class="row-gs-1">
				...
				<h2 class="header_title"><?php if(get_field('rental_ar_head')){ the_field('rental_ar_head'); }?></h2>

				<div class="text-updation light-text">

					<p><?php if(get_field('rental_ar_paragraph')){ the_field('rental_ar_paragraph'); }?></p>
			...
			<div class="row-gs-1 Img-sample text-center">
				...
				<img src="<?php if(get_field('rental_ar_images')){the_field('rental_ar_images'); }?>"  alt="slx"> 
...
<section class="section-step slider-index mt-0 mb-0">
			...
			<div class="index-Banner call-us-section">
				...
				<div class="banner-up">
					...
					<div class="banner-p">
						...
						<p>Hi I’m Merijn do you need <b>advice</b> from an <b>expert?</b>  You can call me  +31 30 711 6183 (9:00 – 17:00)</p>

					</div>

					<a class="contact-btn medium-txt" href="<?php echo get_site_url(); ?>/contact">Contact Us</a>
